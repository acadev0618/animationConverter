<template>
    <div class="canvasTestEditor">
        <!--        <div class="layout-body">-->


        <div class="layout-main" ref="editorMain">

            <canvas-test-main></canvas-test-main>
...
<script>
    import CanvasTestMain from './canvas-test-main/canvasTestMain.vue';
    ...
    export default {
        name: "canvas-test-editor",
        components: {VideoEditorTimeline, VideoEditorLayers, CanvasTestMain},
        methods: {
            workingSize() {
                return {
