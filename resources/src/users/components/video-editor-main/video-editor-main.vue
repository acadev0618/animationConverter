<template>
    <div class="video-editor-main" @click="onClick($event)" ref="videoEditorMain">
...
<script src="./video-editor-main.js"></script>

<style scoped lang="scss" src="./video-editor-main.scss"></style>
<style lang="scss">
    .range-slider.slider{
        display: block;
        width: 100%;
