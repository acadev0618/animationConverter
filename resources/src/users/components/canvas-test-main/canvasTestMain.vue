<template>
    <div class="canvasTestMain" @click="onClick($event)" ref="canvasTestMain">
...
<script src="./canvasTestMain.js"></script>

<style scoped lang="scss" src="./canvasTestMain.scss"></style>
<style lang="scss">
    .range-slider.slider{
        display: block;
        width: 100%;
