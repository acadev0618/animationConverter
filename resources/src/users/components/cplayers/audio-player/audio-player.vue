<template>
    <div class="component-audio-player">
        ...
        <audio :autoplay="autoPlay" style="display: none;" v-on:timeupdate="timeUpdate" v-on:loadeddata="loadedData" ref="audio">
            <source :src="element.content.src" ref="audioSrc"/>
...
<style scoped lang="scss" src="./audio-player.scss"></style>
