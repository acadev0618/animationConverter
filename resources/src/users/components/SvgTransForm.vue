<template>
    <svg :class="{[`${classPrefix}-transform`]: true, [`${classPrefix}-transform--active`]:selected}"
         :style="styles">
        <svg :class="`${classPrefix}-transform__content`" :style="computedStyles.elementSizePos">
            <svg class="animation--wrap" :style="computedAnimation">
                <svg class="rotate--wrap" :style="computedStyles.rotate">
                    <slot></slot>
                </svg>
            </svg>
        </svg>
        <svg v-if="selected && state === 'edit' && canTransform"
    ...
    export default {
        ...
        computed: {
            computedStyles() {
                ...
                console.log(' i am in  SvgTransForm computedStyles ');
