        ...
        <div class="card bg-primary-card">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            <button type="button" class="btn btn-primary" @click.prevent.stop="$router.go(-1)"><i class="fas fa-angle-left"></i> Go slide list</button>
                        </div>
                        <div class="form-group mb-2">
                            <label class="label">Slide Name</label>
                            <input type="text" v-model="models.name" class="form-control"/>
                        </div>
                    ...
                    <div class="col-md-12">
                        <button class="btn btn-info" :disabled="models.name === '' || models.data_json === ''" @click="save">Save</button>
                    </div>
                </div>
            </div>
        </div>
